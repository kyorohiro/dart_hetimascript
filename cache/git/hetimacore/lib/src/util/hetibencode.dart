...
class HetiBdecoder {
  ...
  async.Future<int> decodeNumber(EasyParser parser) {
    ...
    parser.nextString("i").then((String v) {
      return parser.nextBytePatternByUnmatch(new EasyParserIncludeMatcher(DIGIT));
  ...
  async.Future<List<int>> decodeBytes(EasyParser parser) {
    ...
    int length = 0;
    parser.nextBytePatternByUnmatch(new EasyParserIncludeMatcher(DIGIT)).then((List<int> lengthList) {
